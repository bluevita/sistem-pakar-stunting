        ...
        <div class="card-deck">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <p class="card-text">
              Pengguna harus melakukan login sebelum dapat melanjutkan ke tahap selanjutnya, dan jika belum memiliki akun, mereka akan diarahkan ke menu registrasi.
              </p>
            </div>
          </div>
          <div class="card">
            ...
            <div class="card-body">
              <p class="card-text">Dalam tahap ini, pengguna akan diminta menjawab beberapa pertanyaan terkait dengan gejala yang mereka alami.</p>
            </div>
          </div>
          <div class="card">
            ...
            <div class="card-body">
              ...
              <p class="card-text">Tahap ini adalah tahap akhir di mana pengguna akan menerima hasil tes setelah menjawab pertanyaan mengenai gejala yang mereka alami. Hasil tes tersebut akan mencakup nama penyakit yang diduga serta solusi yang dianjurkan.</p>
            </div>
          </div>
        </div>
      </div>
