            ...
            <div class="row">
                <div class="col align-self-center">
                    ...
                    <h5 class="mb-4">
                        <div class="py-1">
                            <strong>
                            Kwashiorkor = <?= $_SESSION['Kwashiorkor']; ?>%
                            </strong>
                        </div>
                        <div class="py-1">
                            <strong>
                            Maramus = <?= $_SESSION['Maramus']; ?>%
                            </strong>
                        </div>
                        <div class="py-1">
                            <strong>
                            Stunting = <?= $_SESSION['Stunting']; ?>%
                            </strong>
                        </div>
                    </h5>
                        <?php } ?>
                    ...
                    <?php
                        ...
                        $id_penyakit = maximum($_SESSION['Kwashiorkor'], $_SESSION['Maramus'], $_SESSION['Stunting']);
